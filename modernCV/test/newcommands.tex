...
\fbox{\begin{minipage}[t]{2.3cm}%    la date
\begin{flushleft}%
#1%
\end{flushleft}%
\end{minipage}}%
\hspace{2mm}%
%
\fbox{\begin{minipage}[t]{.98\textwidth - 2.7cm}%   nom du diplôme, établissement et lieu
%
\fbox{\begin{minipage}[t]{.98\textwidth}%  Non du dipôme
\textbf{#2,}\vspace{1mm}%
\end{minipage}}%
\newline%
\fbox{\begin{minipage}[t]{.98\textwidth}%    etablissement et lieu
\begin{flushleft}%
