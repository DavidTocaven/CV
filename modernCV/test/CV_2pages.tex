...
\partie{Diplômes}%
\noindent\fbox{\begin{minipage}[t]{.72\textwidth}%
...
\end{minipage}} %\vline\hspace{2mm}%
\noindent\fbox{\begin{minipage}[t]{.22\textwidth}
\fbox{\includegraphics[width=.95\textwidth]{./logo_ups.png}}
\end{minipage}}\hfill%
...
\experience{2016--2017}{4 semaines}{{\textcolor{darkred}{LAAS-CNRS}}}{{\textcolor{darkred}{Toulouse}}}{Stage}{\textit{Modèle DEVS, temps~discrets, événements~discrets, modélisation.}}
\vspace{2mm}

\experience{2016--2017}{6 mois}{{\textcolor{darkred}{Université Toulouse III -- Paul Sabatier}}}{{\textcolor{darkred}{Toulouse}}}{Projet master}{\textit{Méthode scientifique, automates, gestion~de~projet, Matlab.}}
\vspace{2mm}
\experience{2016--2017}{5 semaines}{{\textcolor{darkred}{LAPLACE}}}{{\textcolor{darkred}{Toulouse}}}{Stage}{\textit{Optique, traitement~d’image, thermique, Matlab, \LaTeX, découverte du monde de la recherche.}}
\vspace{2mm}
\experience{2016 à aujourd'hui}{}{}{{\textcolor{darkred}{Toulouse}}}{Cours particulier}{\textit{Pédagogie, mathématique, automatique, visualisation.}}
