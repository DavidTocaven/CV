...
\tripleitemise[\bcbook]{Literature}[\bcfleur]{Travels}[\bcvelo]{Do-it-yourself (bike trailer, electronic, …)}%{Veille scientifique}[\bcfleur]{Voyages}[\bcvelo]{Bricolage (remorque vélo, électronique, …)}
\end{samepage}%
\end{document}
