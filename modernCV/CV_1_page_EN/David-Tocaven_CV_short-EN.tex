...
\title{\huge Master's degree in real time systems and automation} % fr : Master d'automatique et de système temps réel     % optional, remove / comment the line if not wanted
...
% -----------------------
\diplome{2015 -- 2018}{Real-time systems engineering - EEA master's degree}%Master EEA-Ingénierie des Systèmes Temps-Réels
...
\experience{2016\ $ \;\text{to}\; $ present}{}{}{Toulouse}%
...
\tripleitemise[\faCamera]{Photography}[\bcfleur]{Travels}[\bcvelo]{Do-it-yourself (bike trailer, electronic, …)}%{Veille scientifique}[\bcfleur]{Voyages}[\bcvelo]{Bricolage (remorque vélo, électronique, …)}
\end{samepage}%
\end{document}
